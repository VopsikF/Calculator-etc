...
namespace calculator
{
    public class TextBox2 : Control
    {
        ...
        private string inputText = "";  // Field for displaying the entered text
        ...
        protected override void OnKeyPress(KeyPressEventArgs e)
        {
            ...
            // Allow only digits, comma and Backspace input
            if (char.IsDigit(e.KeyChar) || (e.KeyChar == ',' && !inputText.Contains(",")) || e.KeyChar == (char)Keys.Back)
            {
